...
/*!
 * Dark Side v6.3 — multi-source aggregator for Lampa
...
(function(){
  ...
  const TEST_JSON_URL = 'http://example.com/darkside_test_extended.json'; // HTTP allowed
  ...
  function log(...a){ try{ console.log('[DarkSide v6.3]', ...a);}catch(e){} }
